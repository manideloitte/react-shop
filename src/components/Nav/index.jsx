...
const Nav = () => {
    ...
    return <nav key={themeContext.cartData.lastUpdated } class="
    relative
    w-full
    flex flex-wrap
    items-center
    ...
    <a class="text-gray-500 hover:text-gray-700 focus:text-gray-700 mr-4" href="#">
      ...
      <span id="cart-count" class="text-white bg-red-700 absolute rounded-full text-xs -mt-2.5 ml-2 py-0 px-1.5">{items.length}</span>
    </a>
